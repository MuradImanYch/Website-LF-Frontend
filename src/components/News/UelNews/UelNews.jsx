    ...
    return (
        <div id='uelNews' className='newsHr leagueNews'>
            ...
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='ЛЕ'><img loading="lazy" src={uelLogo} alt="uelLogo" /></Tippy>
                </LazyLoad>
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Новости - Лига европы УЕФА</h1>
            </div>
            <section>
                {news}
            </section>
