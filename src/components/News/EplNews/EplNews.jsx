    ...
    return (
        <div id='eplNews' className='newsHr leagueNews'>
            ...
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='АПЛ'><img loading="lazy" src={eplLogo} alt="eplLogo" /></Tippy>
                </LazyLoad>
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Новости - Английская Премьер-Лига</h1>
            </div>
            <section>
                {news}
            </section>
