    ...
    return (
        <div id='eplNews' className='newsHr leagueNews'>
            <Helmet>
                ...
                <meta name="keywords" content="апл, английская премьер лига, английский футбол, футбол, манчестер сити, челси, арсенал, ливерпуль, новости, новости апл" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy content='АПЛ'><img loading="lazy" src={eplLogo} alt="eplLogo" /></Tippy>
                </LazyLoad>
                <h1 className="pageName">Новости - Английская Премьер-Лига</h1>
            </div>
            <section>
                {news}
            </section>
