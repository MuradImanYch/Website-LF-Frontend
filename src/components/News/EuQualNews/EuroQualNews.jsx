    ...
    return (
        <div id='euQualNews' className='newsHr leagueNews'>
            ...
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='Европейская квалификация'><img loading="lazy" src={euQualLogo} alt="euQualLogo" /></Tippy>
                </LazyLoad>
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Новости - Европейская квалификация</h1>
            </div>
            <section>
                {news}
            </section>
