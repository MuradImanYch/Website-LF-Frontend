    ...
    return (
        <div id='rplNews' className='newsHr leagueNews'>
            ...
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='РПЛ'><img loading="lazy" src={rplLogo} alt="rplLogo" /></Tippy>
                </LazyLoad>
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Новости - Российская Премьер-Лига</h1>
            </div>
            <section>
                {news}
            </section>
