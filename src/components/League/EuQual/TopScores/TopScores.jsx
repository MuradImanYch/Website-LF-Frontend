...
const TopScores = () => {
    ...
    return (
        <div className='leagueTopScores table6xn'>
            <Helmet>
                <title>Европейская Квалификация - Список бомбардиров - на Legendary Football</title>
                <meta name="description" content="Таблица бомбардиров отборочного турнира." />
                <meta name="keywords" content="европейская квалификация, отборочный турнир сборных, европейский футбол, футбол, сборная германии, сборная португалии, сборная англии, сборная франции, таблица бомбардиров европейской квалификации, список бомбардиров европейской квалификации" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Бомбардиры - Европейская квалификация</h1>
            </div>
            <div className="head">
