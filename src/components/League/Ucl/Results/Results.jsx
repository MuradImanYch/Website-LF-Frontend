  ...
  useEffect(() => {
    ...
    return (
        <div className='leagueResults'>
          <Helmet>
                <title>Лига Чемпионов (ЛЧ) - результаты матчей - на Legendary Football</title>
                <meta name="description" content="Результаты матчей Лиги Чемпионов (ЛЧ)." />
                <meta name="keywords" content="лч, лига чемпионов, европейский футбол, футбол, реал мадрид, атлетико мадрид, бавария, манчестер сити, результаты лч, прошедшие матчи лч" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy content='ЛЧ'><img src={logo} alt="logo" /></Tippy>
                </LazyLoad>
                <h1 className="pageName">Результаты - Лига Чемпионов</h1>
            </div>
