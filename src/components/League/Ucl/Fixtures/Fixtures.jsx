...
const Fixtures = () => {
    ...
    return (
        <div className='leagueFixtures'>
          <Helmet>
                <title>Лига Чемпионов (ЛЧ) - расписание матчей - на Legendary Football</title>
                <meta name="description" content="Календарь матчей Лиги Чемпионов (ЛЧ)." />
                <meta name="keywords" content="лч, лига чемпионов, европейский футбол, футбол, бавария, реал мадрид, ливерпуль, милан, манчестер сити, календарь лч, расписание лч" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy content='ЛЧ'><img src={logo} alt="logo" /></Tippy>
                </LazyLoad>
                <h1 className="pageName">Календарь - Лига Чемпионов</h1>
            </div>
