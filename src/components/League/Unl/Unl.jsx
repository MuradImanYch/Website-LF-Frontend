...
const Unl = () => {
    ...
    let endpoints = ['/standings/unla1', '/standings/unla2', '/standings/unla3', '/standings/unla4, /standings/unlb1', '/standings/unlb2', '/standings/unlb3', '/standings/unlb4, /standings/unlc1', '/standings/unlc2', '/standings/unlc3', '/standings/unlc4, /standings/unld1', '/standings/unld2'];
    ...
    return (
        <div id='leagueUnl'>
            <Helmet>
                <title>Лига Наций УЕФА (ЛН) - новости, результаты, расписание матчей, турнирная таблица</title>
                <meta name="description" content="Изучайте последние новости, результаты и турнирную таблицу Лиги Наций (ЛН) на нашем сайте." />
                <meta name="keywords" content="лига наций уефа, новости лиги наций, лига наций уефа, турнирная таблица лига наций уефа, европейский футбол, лига наций, сборная англии, сборная испании, сборная франции, сборная португалии, список бомбардиров, бомбардиры, ближайшие матчи, последние результаты лига наций" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        ...
                        <div>
                            <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Лига наций УЕФА <span style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Сезон: {season}</span></h1>
            ...
            <div className="standingsTopScores">
                <div className="standingsWrap">
                    ...
                    <div className="table5xn standings">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/unl/standings">Подробнее</Link>
                    </div>
                </div>
                ...
                <div className="topScoresWrap">
                    ...
                    <div className="table6xn topScores">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/unl/topscores">Подробнее</Link>
                    </div>
                </div>
            </div>
            ...
            <div className="ranksNewsTransfers">
                <div className="ranksWrap">
                    <div className="ranks">
                        <h2 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="sectionName">Рейтинг ассоциаций УЕФА</h2>
                        <div className="wrap">
                            <div className="head">
                                <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content="Позиция"><span>#</span></Tippy>
