...
const Standings = () => {
    ...
    return (
        <div className='leagueStandings eurocups'>
            <Helmet>
                <title>Лига Наций (ЛН) - Турнирная таблица - на Legendary Football</title>
                <meta name="description" content="Турнирная таблица Лиги Наций (ЛН)." />
                <meta name="keywords" content="лн, лига наций, отборочные матчи, футбол, сборная португалии, сборная франции, сборная испании, сборная англии, таблица лн, турнирная таблица лн" />
            </Helmet>
