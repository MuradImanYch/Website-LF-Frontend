  ...
  useEffect(() => {
    ...
    return (
        <div className='leagueResults'>
          <Helmet>
                <title>Лига Наций (ЛН) - результаты матчей - на Legendary Football</title>
                <meta name="description" content="Результаты матчей Лиги Наций (ЛН)." />
                <meta name="keywords" content="лн, лига наций, европейский футбол, футбол, сборная португалии, сборная франции, сборная испании, сборная англии, результаты лн, прошедшие матчи лн" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy content='Лига наций'><img loading="lazy" src={logo} alt="logo" /></Tippy>
                </LazyLoad>
                <h1 className="pageName">Результаты - Лига наций</h1>
            </div>
