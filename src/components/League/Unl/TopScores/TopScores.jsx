...
const TopScores = () => {
    ...
    return (
        <div className='leagueTopScores table6xn'>
            <Helmet>
                <title>Лига Наций УЕФА (ЛН) - Список бомбардиров</title>
                <meta name="description" content="Таблица бомбардиров отборочного турнира Лиги Наций (ЛН)." />
                <meta name="keywords" content="лига наций уефа бомбардиры, лига наций бомбардиры, европейский футбол бомбардиры, бомбардиры лига наций, сборная германии бомбардиры, сборная англии бомбардиры, сборная португалии бомбардиры, сборная испании бомбардиры, таблица бомбардиров лиги наций, список бомбардиров лиги наций уефа" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='Лига наций'><img loading="lazy" src={logo} alt="logo" /></Tippy>
                </LazyLoad>
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Бомбардиры - Лига наций УЕФА</h1>
            </div>
            <div className="head">
