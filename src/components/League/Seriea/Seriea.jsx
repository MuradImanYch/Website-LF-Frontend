    ...
    return (
        <div id='leagueSeriea'>
            <Helmet>
                ...
                <meta name="keywords" content="серия а, новости, результаты, турнирная таблица, футбол, итальянский футбол, чемпионат италии, ювентус, интер, милан, аталанта, наполи, список трансферов" />
            </Helmet>
           <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy content='Серия А'><img loading="lazy" src={logo} alt="logo" /></Tippy></LazyLoad>
                        </div>
                        <div>
