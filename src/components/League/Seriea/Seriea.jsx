...
const Seriea = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            await axios.get('/leagueinfo/seriea')
            .then(response => {
            ...
            await axios.get('/transfers/seriea')
            .then(response => {
    ...
    return (
        <div id='leagueEuQual'>
            <Helmet>
                <title>Чемпионат Италии (Серия А) - новости, результаты, расписание матчей, турнирная таблица</title>
                <meta name="description" content="Читайте последние новости, результаты и турнирную таблицу Серии А на нашем сайте." />
                <meta name="keywords" content="серия а, новости серии а, результаты чемпионата италии, турнирная таблица серия а, итальянский футбол, чемпионат италии, ювентус, интер, милан, аталанта, наполи, список трансферов, бомбардиры серия а, серия а ближайшие матчи, чемпионат италии последние результаты" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content={`Серия А ${config['serie-a-season']}`}><img loading="lazy" src={logo} alt={`Серия А ${config['serie-a-season']}`} /></Tippy></LazyLoad>
                        </div>
                        <div>
                            <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Серия А {config['serie-a-season']}</h1>
                            <span style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Место проведения: <span style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Италия</span></span>
                        </div>
                    </div>
                    <div className="right">
            ...
            <div className="standingsTopScores">
                <div className="standingsWrap">
                    ...
                    <div className="table5xn standings">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/seriea/standings">Подробнее</Link>
                    </div>
                </div>
                ...
                <div className="topScoresWrap">
                    ...
                    <div className="table6xn topScores">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/seriea/topscores">Подробнее</Link>
                    </div>
                </div>
            </div>
            <div className="matchesResultNews">
                <div className="resultsWrap">
                    ...
                    <div className="wrap">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to={'/league/seriea/fixtures'}>Подробнее</Link>
                    </div>
                </div>
                <div className="newsWrap newsVr leagueNews">
                    {news2}
            ...
            <div className="newsFixtures">
                ...
                <div className="resultsWrap">
                    ...
                    <div className="wrap">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to={'/league/seriea/results'}>Подробнее</Link>
                    </div>
                </div>
            </div>
