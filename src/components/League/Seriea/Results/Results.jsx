...
const Results = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
                <title>Чемпионат Италии (Серия А) - Результаты матчей</title>
            ...
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Результаты - Серия А {config['serie-a-season']}</h1>
            </div>
