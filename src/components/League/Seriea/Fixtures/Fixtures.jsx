...
const Fixtures = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
                <title>Чемпионат Италии (Серия А) - Расписание матчей</title>
                <meta name="description" content="Календарь матчей чемпионата Италии (Серии А)." />
                <meta name="keywords" content="серия а расписание, расписание серии а, серия а расписание матчей, чемпионат италии календарь, итальянский футбол расписание, ювентус расписание, интер расписание, наполи расписание, рома расписание, аталанта расписание, лацио расписание, календарь серии а, чемпионат италии расписание, календарь чемпионта италии" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Календарь - Серия А {config['serie-a-season']}</h1>
            </div>
