...
const Results = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
              <title>Чемпионат Испании (Ла лига) - Результаты матчей</title>
              <meta name="description" content="Результаты матчей чемпионата Испании (Ла лига)." />
              <meta name="keywords" content="ла лига результаты, ла лига матчи, результаты ла лиги, результаты чемпионата испании, чемпионат испании результаты, реал мадрид результаты, атлетико мадрид результаты, барселона результаты, севилья результаты" />
          </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Результаты - Ла Лига {config['la-liga-season']}</h1>
            </div>
