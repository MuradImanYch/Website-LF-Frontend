...
const Standings = () => {
    ...
    return (
        <div className='leagueStandings eurocups'>
            <Helmet>
                <title>Чемпионат Испании (Ла лига) - Турнирная таблица</title>
                <meta name="description" content="Турнирная таблица чемпионата Испании (Ла лиги)." />
                <meta name="keywords" content="ла лига турнирная таблица, чемпионат испании таблица, испанский футбол таблица, ла лига таблица, таблица ла лиги, реал мадрид таблица, барселона таблица, атлетко мадрид таблица, севилья таблица, турнирная таблица ла лиги" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 className="pageName" style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Турнирная таблица - Ла Лига {config['la-liga-season']}</h1>
            </div>
