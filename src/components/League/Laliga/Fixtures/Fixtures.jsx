...
const Fixtures = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
                <title>Чемпионат Испании (Ла лига) - Расписание матчей</title>
                <meta name="description" content="Календарь матчей чемпионата испании (Ла лиги)." />
                <meta name="keywords" content="ла лига расписание, ла лига матчи, расписание ла лиги, ла лига расписание матчей, чемпионат испании расписание, календарь ла лиги, ла лига календарь, расписание испанский футбол, реал мадрид расписание, атлетико мадрид расписание, барселона расписание, севилья расписание" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Календарь - Ла Лига {config['la-liga-season']}</h1>
            </div>
