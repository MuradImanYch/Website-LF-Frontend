...
const Fixtures = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
              const response = await axios.get('/fixtures/laliga');
    ...
    return (
        <div className='leagueFixtures'>
          <Helmet>
                <title>Ла лига - расписание матчей - на Legendary Football</title>
                <meta name="description" content="Календарь матчей чемпионата испании (Ла лиги)." />
                <meta name="keywords" content="ла лига, чемпионат испании, испанский футбол, футбол, реал мадрид, атлетико мадрид, барселона, севилья, календарь ла лиги, расписание ла лиги" />
            </Helmet>
