    ...
    return (
        <div id='leagueLaliga'>
            <Helmet>
                ...
                <meta name="keywords" content="ла лига, новости, результаты, турнирная таблица, футбол, испанский футбол, чемпионат испании, реал мадрид, барселона, севилья, валенсия, вильяреал, примера" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy content='Ла Лига'><img loading="lazy" src={logo} alt="logo" /></Tippy></LazyLoad>
                        </div>
                        <div>
