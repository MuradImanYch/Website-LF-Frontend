...
const Laliga = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            await axios.get('/leagueinfo/laliga')
            .then(response => {
            ...
            await axios.get('/fixtures/laliga')
            .then(response => {
                let filtered = response.data.filter(e => {
                    return e.round === response.data[0].round;
                });
            ...
            await axios.get('/transfers/laliga')
            .then(response => {
    ...
    return (
        <div id='leagueLaliga'>
            <Helmet>
                <title>Ла лига - новости, результаты, расписание матчей, турнирная таблица и много чего - на Legendary Football</title>
                <meta name="description" content="Изучайте последние новости, результаты и турнирную таблицу чемпионата испании на нашем сайте. У нас вы найдете все необходимые материалы о главном испанском футбольном чемпионате и в целом об испанском футболе." />
                <meta name="keywords" content="ла лига, новости, результаты, турнирная таблица, футбол, испанский футбол, чемпионат испании, реал мадрид, барселона, севилья, валенсия, вильяреал, примера, бомбардиры, ближайшие матчи, последние результаты, рейтинг в уефа, рейтинг в фифа, список популярных трансферов, видео, блоги" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='Ла Лига'><img loading="lazy" src={logo} alt="logo" /></Tippy></LazyLoad>
                        </div>
                        <div>
                            <h1 className="pageName">Ла Лига <span>Сезон: {season}</span></h1>
                            <span>Место проведения: <span>Испания</span></span>
                        </div>
                    </div>
                    <div className="right">
                    ...
                    <div className="ranks">
                        ...
                        <div className="wrap">
                            ...
                            <div className="flagPlace">
                                ...
                                <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='Позиция'><span className="place">#<span>{uefaRankName && uefaRankName[0].place}</span></span></Tippy>
                            </div>
                            <div className="head">
                    ...
                    <div className="ranks">
                        ...
                        <div className="wrap">
                            ...
                            <div className="flagPlace">
                                ...
                                <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='Позиция'><span className="place">#<span>{fifaRankName && fifaRankName[0].place}</span></span></Tippy>
                            </div>
                            <div className="head">
                                <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content="Сумма очков"><span className='total'>Сумма</span></Tippy>
                            </div>
