...
const Laliga = () => {
    ...
    return (
        <div id='leagueEuQual'>
            <Helmet>
                <title>Чемпионат Испании (Ла лига) - новости, результаты, расписание матчей, турнирная таблица</title>
                <meta name="description" content="Изучайте последние новости, результаты и турнирную таблицу чемпионата Испании на нашем сайте." />
                <meta name="keywords" content="ла лига, новости ла лига, результаты ла лига, ла лига турнирная таблица, испанский футбол, чемпионат испании, реал мадрид, барселона, севилья, валенсия, вильяреал, примера, бомбардиры чемпионата испании" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content={`Ла Лига ${config['la-liga-season']}`}><img loading="lazy" src={logo} alt={`Ла Лига ${config['la-liga-season']}`} /></Tippy></LazyLoad>
                        </div>
                        <div>
                            <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Ла Лига {config['la-liga-season']}</h1>
                            <span style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Место проведения: <span style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Испания</span></span>
                        </div>
                    </div>
                    <div className="right">
            ...
            <div className="standingsTopScores">
                <div className="standingsWrap">
                    ...
                    <div className="table5xn standings">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/laliga/standings">Подробнее</Link>
                    </div>
                </div>
                ...
                <div className="topScoresWrap">
                    ...
                    <div className="table6xn topScores">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/laliga/topscores">Подробнее</Link>
                    </div>
                </div>
            </div>
            <div className="matchesResultNews">
                <div className="resultsWrap">
                    ...
                    <div className="wrap">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to={'/league/laliga/fixtures'}>Подробнее</Link>
                    </div>
                </div>
                <div className="newsWrap newsVr leagueNews">
                    {news2}
            ...
            <div className="newsFixtures">
                ...
                <div className="resultsWrap">
                    ...
                    <div className="wrap">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to={'/league/laliga/results'}>Подробнее</Link>
                    </div>
                </div>
            </div>
