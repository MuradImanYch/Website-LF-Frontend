...
const Results = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
                <title>Чемпионат Германии (Бундеслига) - Результаты матчей</title>
                <meta name="description" content="Результаты матчей чемпионата Германии (Бундеслиги)." />
                <meta name="keywords" content="бундеслига результаты, результаты чемпионата германии, немецкий футбол результаты матчей, бавария результаты, боррусия дортмунд результаты, лейпциг результаты, айнтрахт франкфурт результаты, результаты бундеслиги, прошедшие матчи бундеслиги" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Результаты - Бундеслига {config['bundesliga-season']}</h1>
            </div>
