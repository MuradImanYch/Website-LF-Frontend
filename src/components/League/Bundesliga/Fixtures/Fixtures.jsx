...
const Fixtures = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
                <title>Чемпионат Германии (Бундеслига) - Расписание матчей</title>
                <meta name="description" content="Календарь матчей чемпионата Германии (Бундеслиги)." />
                <meta name="keywords" content="бундеслига расписание, бундеслига календарь, календарь чемпионата германии, расписание бундеслиги, немецкий футбол расписание, бавария, боррусия дортмунд, лейпциг, айнтрахт франкфурт, календарь бундеслиги, расписание бундеслига" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Календарь - Бундеслига {config['bundesliga-season']}</h1>
            </div>
