...
const TopScores = () => {
    ...
    return (
        <div className='leagueTopScores table6xn'>
            <Helmet>
                <title>Чемпионат Германии (Бундеслига) - Список бомбардиров</title>
                <meta name="description" content="Таблица бомбардиров чемпионата Германии (Бундеслиги)." />
                <meta name="keywords" content="бундеслига бомбардиры, чемпионат германии таблица бомбардиров, немецкий футбол бомбардиры, бундеслига таблица бомбардиров, бавария бомбардиры, боррусия дортмунд бомбардиры, лейпциг бомбардиры, айнтрахт франкфурт бомбардиры, таблица бомбардиров бундеслиги, список бомбардиров бундеслиги, бомбардиры бундеслиги" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content={`Бундеслига ${config['bundesliga-season']}`}><img loading="lazy" src={logo} alt={`Бундеслига ${config['bundesliga-season']}`} /></Tippy>
                </LazyLoad>
