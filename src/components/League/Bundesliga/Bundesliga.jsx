    ...
    return (
        <div>
            <Helmet>
                ...
                <meta name="keywords" content="бундеслига, новости, результаты, турнирная таблица, футбол, немецкий футбол, чемпионат германии, бавария, боррусия дортмунд, лейпциг, айнтрахт франкфурт, серебрянная салатница" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy content='Бундеслига'><img loading="lazy" src={logo} alt="logo" /></Tippy></LazyLoad>
                        </div>
                        <div>
