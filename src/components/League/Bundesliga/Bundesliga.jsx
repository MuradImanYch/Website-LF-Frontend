...
const Bundesliga = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const options = {
                ...
                params: {
                  season: `${config['bundesliga-season'].split('/')[0]}`,
                  league: '78'
                },
                headers: {
            ...
            await axios.get('/leagueinfo/bundesliga')
            .then(response => {
            ...
            await axios.get('/transfers/bundesliga')
            .then(response => {
    ...
    return (
        <div id='leagueEuQual'>
            <Helmet>
                <title>Чемпионат Германии (Бундеслига) - новости, результаты, расписание матчей, турнирная таблица</title>
                <meta name="description" content="Изучайте последние новости, результаты и турнирную таблицу Бундеслиги на нашем сайте." />
                <meta name="keywords" content="бундеслига, новости бундеслиги, результаты бундеслига, бундеслига турнирная таблица, немецкий футбол, чемпионат германии расписание, бавария, боррусия дортмунд, лейпциг, айнтрахт франкфурт, серебрянная салатница, бомбардиры, ближайшие матчи чемпионата германии, последние результаты чемпионата германии" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content={`Бундеслига ${config['bundesliga-season']}`}><img loading="lazy" src={logo} alt={`Бундеслига ${config['bundesliga-season']}`} /></Tippy></LazyLoad>
                        </div>
                        <div>
                            <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Бундеслига {config['bundesliga-season']}</h1>
                            <span style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Место проведения: <span style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Германия</span></span>
                        </div>
                    </div>
                    <div className="right">
            ...
            <div className="standingsTopScores">
                <div className="standingsWrap">
                    ...
                    <div className="table5xn standings">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/bundesliga/standings">Подробнее</Link>
                    </div>
                </div>
                ...
                <div className="topScoresWrap">
                    ...
                    <div className="table6xn topScores">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/bundesliga/topscores">Подробнее</Link>
                    </div>
                </div>
            </div>
            <div className="matchesResultNews">
                <div className="resultsWrap">
                    ...
                    <div className="wrap">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to={'/league/bundesliga/fixtures'}>Подробнее</Link>
                    </div>
                </div>
                <div className="newsWrap newsVr leagueNews">
                    {news2}
            ...
            <div className="newsFixtures">
                ...
                <div className="resultsWrap">
                    ...
                    <div className="wrap">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to={'/league/bundesliga/results'}>Подробнее</Link>
                    </div>
                </div>
            </div>
