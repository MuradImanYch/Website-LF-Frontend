...
const Standings = () => {
    ...
    return (
        <div className='leagueStandings eurocups'>
            <Helmet>
                <title>Чемпионат Германии (Бундеслига) - Турнирная таблица</title>
                <meta name="description" content="Турнирная таблица чемпионата Германии (Бундеслиги)." />
                <meta name="keywords" content="бундеслига турнирная таблица, бундеслига таблица, чемпионат германии таблица, немецкий футбол таблица, бавария таблица, боррусия дортмунд таблица, лейпциг таблица, айнтрахт франкфурт таблица, таблица бундеслиги, турнирная таблица бундеслиги" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 className="pageName" style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Турнирная таблица - Бундеслига {config['bundesliga-season']}</h1>
            </div>
