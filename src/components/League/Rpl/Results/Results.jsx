...
const Results = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
              const response = await axios.get('/results/rpl');
    ...
    return (
        <div className='leagueResults'>
          <Helmet>
                <title>Российская Премьер Лига (РПЛ) - результаты матчей - на Legendary Football</title>
                <meta name="description" content="Результаты матчей чемпионата россии (РПЛ)." />
                <meta name="keywords" content="рпл, чемпионат россии, российский футбол, футбол, зенит, цска, краснодар, спартак москва, ахмат, результаты рпл, прошедшие матчи рпл" />
            </Helmet>
