...
const Results = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
                <title>Российская Премьер Лига (РПЛ) - Результаты матчей</title>
                <meta name="description" content="Результаты матчей чемпионата России (РПЛ)." />
                <meta name="keywords" content="рпл результаты, результаты рпл, результаты чемпионата россии, рпл результаты матчей, результаты зенит, результаты цска, результаты краснодар, результаты спартак москва, результаты ахмат, прошедшие матчи рпл" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Результаты - Российская Премьер-Лига {config['russian-premier-league-season']}</h1>
            </div>
