...
const Fixtures = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
                <title>Российская Премьер Лига (РПЛ) - Расписание матчей</title>
                <meta name="description" content="Календарь матчей чемпионата России (РПЛ)." />
                <meta name="keywords" content="расписание рпл, рпл расписание, рпл расписание матчей, рпсписание российской премьер лиги, зенит расписание, цска расписание, краснодар расписание, спартак москва расписание, календарь рпл, календарь российской премьер лиги" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Календарь - Российская Премьер-Лига {config['russian-premier-league-season']}</h1>
            </div>
