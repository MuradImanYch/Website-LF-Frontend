...
const Results = () => {
    ...
    return (
        <div className='leagueFixtures'>
          <Helmet>
                <title>Чемпионат Европы {config['european-championship-season']} (ЕВРО {config['european-championship-season']}) - Результаты матчей</title>
                <meta name="description" content={`Результаты матчей чемпионата Европы по футболу ${config['european-championship-season']} (ЕВРО ${config['european-championship-season']}).`} />
                <meta name="keywords" content={`че ${config['european-championship-season']} результаты, евро ${config['european-championship-season']} результаты, результаты че ${config['european-championship-season']}, итоги евро ${config['european-championship-season']}, чемпионат европы ${config['european-championship-season']} результаты матчей, матчи че ${config['european-championship-season']}, че ${config['european-championship-season']} матчи, чемпионат европы результат`} />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Результаты - Чемпионат Европы {config['european-championship-season']}</h1>
            </div>
