...
const Epl = () => {
    ...
    return (
        <div id='leagueEuQual'>
            <Helmet>
                <title>Английская Премьер Лига (АПЛ) - новости, результаты, расписание матчей, турнирная таблица</title>
                <meta name="description" content="Изучайте последние новости, результаты и турнирную таблицу АПЛ на нашем сайте." />
                <meta name="keywords" content="апл бомбардиры, английская премьер лига таблица, новости апл, результаты английской премьер лиги, турнирная таблица, английский футбол, чемпионат англии новости, результаты манчестер сити, челси, манчестер юнайтед календарь, арсенал календарь, ливерпуль календарь, туманный альбион, апл бомбардиры, ближайшие матчи апл, последние результаты апл" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content={`АПЛ ${config['england-premier-league-season']}`}><img loading="lazy" src={logo} alt={`АПЛ ${config['england-premier-league-season']}`} /></Tippy></LazyLoad>
                        </div>
                        <div>
                            <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Английская Премьер-Лига {config['england-premier-league-season']}</h1>
                            <span style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Место проведения: <span style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Англия</span></span>
                        </div>
                    </div>
                    <div className="right">
            ...
            <div className="standingsTopScores">
                <div className="standingsWrap">
                    ...
                    <div className="table5xn standings">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/epl/standings">Подробнее</Link>
                    </div>
                </div>
                ...
                <div className="topScoresWrap">
                    ...
                    <div className="table6xn topScores">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to="/league/epl/topscores">Подробнее</Link>
                    </div>
                </div>
            </div>
            <div className="matchesResultNews">
                <div className="resultsWrap">
                    ...
                    <div className="wrap">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to={'/league/epl/fixtures'}>Подробнее</Link>
                    </div>
                </div>
                <div className="newsWrap newsVr leagueNews">
                    {news2}
            ...
            <div className="newsFixtures">
                ...
                <div className="resultsWrap">
                    ...
                    <div className="wrap">
                        ...
                        <Link style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} to={'/league/epl/results'}>Подробнее</Link>
                    </div>
                </div>
            </div>
