    ...
    return (
        <div id="leagueEpl">
            <Helmet>
                ...
                <meta name="keywords" content="апл, английская премьер лига, новости, результаты, турнирная таблица, футбол, английский футбол, чемпионат англии, манчестер сити, челси, манчестер юнайтед, арсенал, ливерпуль, туманный альбион, бомбардиры, ближайшие матчи, последние результаты, рейтинг в уефа, рейтинг в фифа, список популярных трансферов, видео, блоги" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='АПЛ'><img loading="lazy" src={logo} alt="logo" /></Tippy></LazyLoad>
                        </div>
                        <div>
