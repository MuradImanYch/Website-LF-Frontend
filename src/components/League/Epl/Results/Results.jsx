...
const Results = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
                <title>Английская Премьер Лига (АПЛ) - Результаты матчей</title>
                <meta name="description" content="Результаты матчей чемпионата Англии (АПЛ)." />
                <meta name="keywords" content="апл результаты, результаты апл, результаты матчей апл, апл результаты матчей, чемпионат англии результаты матчей, результаты манчестер сити, результаты манчестер юнайтед, результаты челси, результаты арсенал, прошедшие матчи апл" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Результаты - Английская Премьер-Лига {config['england-premier-league-season']}</h1>
            </div>
