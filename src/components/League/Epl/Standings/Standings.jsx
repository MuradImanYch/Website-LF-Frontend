...
const Standings = () => {
    ...
    return (
        <div className='leagueStandings'>
            <Helmet>
                <title>Английская Премьер Лига (АПЛ) - Турнирная таблица - на Legendary Football</title>
                <meta name="description" content="Турнирная таблица чемпионата англии (АПЛ)." />
                <meta name="keywords" content="апл, чемпионат англии, английский футбол, футбол, манчестер сити, челси, манчестер юнайтед, арсенал, таблица апл, турнирная таблица апл" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy content='АПЛ'><img loading="lazy" src={logo} alt="logo" /></Tippy>
                </LazyLoad>
                <h1 className="pageName">Турнирная таблица - Английская Премьер-Лига</h1>
            </div>
