...
const Standings = () => {
    ...
    return (
        <div className='leagueStandings eurocups'>
            <Helmet>
                <title>Английская Премьер Лига (АПЛ) - Турнирная таблица</title>
                <meta name="description" content="Турнирная таблица чемпионата Англии (АПЛ)." />
                <meta name="keywords" content="апл таблица, таблица апл, апл турнирная таблица, английская премьер-лига турнирная таблица, чемпионат англии таблица, манчестер сити таблица, челси таблица, манчестер юнайтед таблица, арсенал таблица, таблица английской премьер лиги, турнирная таблица чемпионата англии" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 className="pageName" style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null}>Турнирная таблица - Английская Премьер-Лига {config['england-premier-league-season']}</h1>
            </div>
