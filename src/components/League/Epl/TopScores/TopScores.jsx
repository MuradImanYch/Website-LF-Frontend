...
const TopScores = () => {
    ...
    return (
        <div className='leagueTopScores table6xn'>
            <Helmet>
                <title>Английская Премьер Лига (АПЛ) - Список бомбардиров</title>
                <meta name="description" content="Таблица бомбардиров чемпионата Англии (АПЛ)." />
                <meta name="keywords" content="апл бомбардиры, бомбардиры апл, чемпионат англии бомбардиры, бомбардиры челси, бомбардиры арсенал, бомбардиры манчестер юнайтед, бомбардиры манчестер сити, таблица бомбардиров апл, список бомбардиров апл, список бомбардиров английской премьер лиги, бомбардиры английской премьер лиги, английская премьер лига бомбардиры" />
            </Helmet>
