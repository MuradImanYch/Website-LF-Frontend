...
const Fixtures = () => {
    ...
    return (
        <div className='leagueFixtures'>
            <Helmet>
                <title>Чемпионат Франции (Лига 1) - Расписание матчей</title>
                <meta name="description" content="Календарь матчей чемпионата Франции (Лиги 1)." />
                <meta name="keywords" content="лига 1 расписание, лига 1 календарь, чемпионат франции календарь, французский футбол расписание, расписание лиги 1, лига 1 матчи, псж расписание, олимпик марсель расписание, олимпик лион расписание, монако расписание, лилль расписание, календарь лиги 1" />
            </Helmet>
            <div className="logoPageName">
                ...
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Календарь - Лига 1 {config['ligue-1-season']}</h1>
            </div>
