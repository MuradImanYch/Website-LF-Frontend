  ...
  function convertGermanToclientTime(germanTime) {
    ...
    return (
        <div className='leagueFixtures'>
          <Helmet>
                <title>Лига Европы - Расписание матчей</title>
                <meta name="description" content="Календарь матчей Лиги Европы (ЛЕ)." />
                <meta name="keywords" content="расписание ле, лига европы расписание, расписание матчей лиги европы, ле расписание, расписание лиги европы, европейский футбол календарь, календарь ле, ле календарь, карабах расписание, ливерпуль расписание, айнтрахт расписание, рома расписание, байер расписание" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='ЛЕ'><img loading="lazy" src={logo} alt="logo" /></Tippy>
                </LazyLoad>
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Календарь - Лига Европы</h1>
            </div>
