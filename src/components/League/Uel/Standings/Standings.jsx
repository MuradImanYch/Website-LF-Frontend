    ...
    return (
        <div className='leagueStandings eurocups'>
            <Helmet>
                ...
                <meta name="keywords" content="ле, лига европы, европейский футбол, футбол, севилья, вильяреал, манчестер юнайтед, айнтрахт франкфурт, таблица ле, турнирная таблица ле" />
            </Helmet>
