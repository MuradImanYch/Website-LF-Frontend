...
const Standings = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            await axios.get('/standings/uela')
            .then(response => {
            ...
            await axios.get('/standings/uelb')
            .then(response => {
            ...
            await axios.get('/standings/uelc')
            .then(response => {
                response.data && response.data.splice(0, 1).map((e) => {
            ...
            await axios.get('/standings/ueld')
            .then(response => {
                response.data && response.data.splice(0, 1).map((e) => {
            ...
            await axios.get('/standings/uele')
            .then(response => {
                response.data && response.data.splice(0, 1).map((e) => {
            ...
            await axios.get('/standings/uelf')
            .then(response => {
                response.data && response.data.splice(0, 1).map((e) => {
            ...
            await axios.get('/standings/uelg')
            .then(response => {
                response.data && response.data.splice(0, 1).map((e) => {
            ...
            await axios.get('/standings/uelh')
            .then(response => {
                response.data && response.data.splice(0, 1).map((e) => {
    ...
    return (
        <div className='leagueStandings eurocups'>
            <Helmet>
                <title>Лига Европы - Турнирная таблица</title>
                <meta name="description" content="Турнирная таблица Лига Европы (ЛЕ)." />
                <meta name="keywords" content="лига европы турнирная таблица, лига европы таблица, таблица ле, европейский футбол турнирная таблица, карабах таблица, ливерпуль таблица, айнтрахт таблица, севилья таблица, турнирная таблица ле, таблица лиги европы" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='ЛЕ'><img loading="lazy" src={logo} alt="logo" /></Tippy>
                </LazyLoad>
                <h1 style={localStorage.getItem('darkTheme') === 'true' ? {color: '#fff'} : null} className="pageName">Турнирная таблица - Лига Европы</h1>
            </div>
