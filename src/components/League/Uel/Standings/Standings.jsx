...
const Standings = () => {
    ...
    return (
        <div className='leagueStandings eurocups'>
            <Helmet>
                <title>Лига Европы - Турнирная таблица - на Legendary Football</title>
                <meta name="description" content="Турнирная таблица Лига Европы (ЛЕ)." />
                <meta name="keywords" content="ле, лига европы, европейский футбол, футбол, севилья, вильяреал, манчестер юнайтед, айнтрахт франкфурт, таблица ле, турнирная таблица ле, лиги европы" />
            </Helmet>
            <div className="logoPageName">
                <LazyLoad offset={800}>
                    <Tippy trigger={$(window).width() < 1024 ? 'click' : 'mouseenter'} content='ЛЕ'><img loading="lazy" src={logo} alt="logo" /></Tippy>
                </LazyLoad>
                <h1 className="pageName">Турнирная таблица - Лига Европы</h1>
            </div>
