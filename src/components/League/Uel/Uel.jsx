    ...
    return (
        <div id='leagueUel'>
            <Helmet>
                ...
                <meta name="keywords" content="ле, новости, результаты, турнирная таблица, футбол, европейский футбол, лига европы, севилья, вильяреал, ливерпуль, айнтрахт франкфурт, список бомбардиров, бомбардиры, ближайшие матчи, последние результаты, рейтинг в уефа, рейтинг в фифа, список популярных трансферов, видео, блоги" />
            </Helmet>
