    ...
    return (
        <div className='leagueStandings eurocups'>
            <Helmet>
                ...
                <meta name="keywords" content="лк, лига конференции, европейский футбол, футбол, рома, вест хем, лейпциг, айнтрахт франкфурт, таблица лк, турнирная таблица лк, лиги конференции" />
            </Helmet>
