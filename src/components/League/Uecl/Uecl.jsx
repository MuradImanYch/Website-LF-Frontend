    ...
    return (
        <div id='leagueUecl'>
            <Helmet>
                ...
                <meta name="keywords" content="лк, новости, результаты, турнирная таблица, футбол, европейский футбол, лига конференции, рома, вест хем, фиорентина, аз алкмаар, список бомбардиров" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        <div>
                            <LazyLoad offset={800}><Tippy content='ЛК'><img loading="lazy" src={logo} alt="logo" /></Tippy></LazyLoad>
                        </div>
                        <div>
