...
const Uecl = () => {
    ...
    return (
        <div id='leagueUecl'>
            <Helmet>
                <title>Лига Конференции (ЛК) - новости, результаты, расписание матчей, турнирная таблица и много чего - на Legendary Football</title>
                <meta name="description" content="Изучайте последние новости, результаты и турнирную таблицу ЛК на нашем сайте. У нас вы найдете все необходимые материалы о лиги конференции." />
                <meta name="keywords" content="лк, новости, результаты, турнирная таблица, футбол, европейский футбол, лига конференции, рома, вест хем, фиорентина, аз алкмаар, список бомбардиров, бомбардиры, ближайшие матчи, последние результаты, рейтинг в уефа, рейтинг в фифа, список популярных трансферов, видео, блоги" />
            </Helmet>
            <div className="logoPageName">
                <div className="info">
                    <div className='left'>
                        ...
                        <div>
                            <h1 className="pageName">Лига Конференции <span>Сезон: {season}</span></h1>
            ...
            <div className="standingsTopScores">
                <div className="standingsWrap">
                    ...
                    <div className="table5xn standings">
                        ...
                        <Link to="/league/uecl/standings">Подробнее</Link>
                    </div>
                </div>
                ...
                <div className="topScoresWrap">
                    ...
                    <div className="table6xn topScores">
                        ...
                        <Link to="/league/uecl/topscores">Подробнее</Link>
                    </div>
                </div>
            </div>
