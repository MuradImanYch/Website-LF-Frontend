...
const TopScores = () => {
    ...
    const next = () => { // next table slider
        $('#topScores .tableWrap .table').eq(0).animate({'left': `${table1-=100}%`});
        $('#topScores .tableWrap .table').eq(1).animate({'left': `${table2-=100}%`});
        $('#topScores .tableWrap .table').eq(2).animate({'left': `${table3-=100}%`});
        if (table3 === -100) {
            table1 += 100;
            table2 += 100;
            table3 += 100;
            $('#topScores .tableWrap .table').eq(0).animate({'left': `${table1}%`});
            $('#topScores .tableWrap .table').eq(1).animate({'left': `${table2}%`});
            $('#topScores .tableWrap .table').eq(2).animate({'left': `${table3}%`});
        }
    }
