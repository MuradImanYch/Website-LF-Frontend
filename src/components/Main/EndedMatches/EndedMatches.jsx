            ...
            setEndedMatches(JSON.parse(localStorage.getItem('endedMatches')) && JSON.parse(localStorage.getItem('endedMatches')).map((e, i) => {
                return  <Tippy key={'endedMatches' + i} offset={[0, 15]} className='endedMatchesTippy' content={e.lName + ' | ' + e.lRound}>
                    <div className="col" id={'endedmatches' + i}>
                            ...
                            <span className="hLogo">{e.hLogo === undefined ? <Tippy content={e.hName}><img width={'13px'} src={undefTeam} alt={e.hName} /></Tippy> : <Tippy content={e.hName}><img src={e.hLogo} alt={e.hName} /></Tippy>}</span>
                            ...
                            <span className="aLogo">{e.aLogo === undefined ? <Tippy content={e.aName}><img width={'13px'} src={undefTeam} alt={e.aName} /></Tippy> : <Tippy content={e.aName}><img src={e.aLogo} alt={e.aName} /></Tippy>}</span>
