    ...
    useEffect(() => { 
            $.ajax({
                ...
                if(response.length > 0) {
                    localStorage.setItem('mainNews2', JSON.stringify(response));
                }
                setMainNews(JSON.parse(localStorage.getItem('mainNews2')) && JSON.parse(localStorage.getItem('mainNews2')).splice(0, 6).map((news, i) => {
